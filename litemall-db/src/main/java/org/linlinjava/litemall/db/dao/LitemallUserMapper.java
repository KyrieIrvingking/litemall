...
public interface LitemallUserMapper {
     ...
     * @return
     */
    List<LitemallUser> selectUnderlingByParentId(@Param("parentUserId") Integer parentUserId);

    /**
     * 根据parentId、角色查询直属下级列表信息
     * @param parentUserId
     * @param userLevel
     * @return
     */
    List<LitemallUser> selectUnderlingInfoListByParentIdAndUserLevel(@Param("parentUserId") Integer parentUserId,@Param("userLevel") Integer[] userLevel,@Param("offset") Integer offset, @Param("pageNum") Integer pageNum);
