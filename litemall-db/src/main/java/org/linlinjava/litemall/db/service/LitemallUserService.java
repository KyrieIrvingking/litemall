...
public class LitemallUserService {
    ...
    public List<LitemallUser> selectUnderlingByParentId(Integer parentUserId){
        return this.userMapper.selectUnderlingByParentId(parentUserId);
    }

    public List<LitemallUser> selectUnderlingInfoListByParentIdAndUserLevel(Integer parentUserId,Integer[] userLevel,int pageIndex,int pageNum){
        return this.userMapper.selectUnderlingInfoListByParentIdAndUserLevel(parentUserId,userLevel,(pageIndex-1)*pageNum,pageNum);
    }
}
