...
public class LitemallUser {
    ...
    private Integer parentUserId; //直接上级id
    private Integer fensiNum; //粉丝数量
    private Float banlance; //可提现余额
    private Integer underlingNum;//直属下级数量
    private String userLevelName;//用户级别名称
    private Integer promotionRate;//佣金比例--有优惠券
    private Integer recommendRate;//推荐比例
    private Integer nocouponRebateRate;//总的返利比例--没有优惠券
    private Integer nocouponRebatePromotionRate;//返利比例--没有优惠券
    private Integer nocouponPromotionRate;//佣金比例--没有优惠券
