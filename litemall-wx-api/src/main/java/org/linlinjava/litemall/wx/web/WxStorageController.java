...
public class WxStorageController {
     ...
     * @return
     */
    @GetMapping("/fetch/{pir}/{cdir}/{key:.+}")
    public ResponseEntity<Resource> fetch(@PathVariable String pir,@PathVariable String cdir,@PathVariable String key) {
        if (key == null) {
            return ResponseEntity.notFound().build();
        }
        if (key.contains("../")) {
        ...
        storage.setStoragePathNew("storage"+"/"+pir+"/"+cdir);
        storage.setAddress("storage/fetch/"+pir+"/"+cdir+"/");
